...
class SessionState(BaseModel):
    ...
    active_agent: Optional[str] = Field(None, description="Currently active agent ID or name")
    current_workflow_id: Optional[str] = Field(None, description="Currently running workflow ID")
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Arbitrary temporary session metadata")
