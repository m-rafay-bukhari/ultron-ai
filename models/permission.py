...
class PermissionRule(BaseModel):
    ...
    target: str = Field(..., description="The target entity (e.g. command prefix, directory path, API endpoint)")
    level: PermissionLevel = Field(default=PermissionLevel.PROMPT, description="Action level when rule is matched")
