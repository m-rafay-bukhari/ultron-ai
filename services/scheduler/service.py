...
class SchedulerService:
    ...
    def schedule_cron(self, name: str, cron_expression: str, task: Callable[[], Coroutine[Any, Any, None]]) -> None:
        logger.info(f"Scheduling task '{name}' with cron expression '{cron_expression}'")
